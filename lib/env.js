...
// Label region yang ditampilkan ke customer di dashboard (Overview cards, dialog create,
// dsb). Bisa di-override lewat env REDIS_REGION_LABEL kalau suatu saat multi-region.
export const REGION_LABEL = process.env.REDIS_REGION_LABEL || "ID-JKT-1";
